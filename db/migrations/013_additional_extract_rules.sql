-- Additional extract rules from customer success meeting extraction guidelines

-- Professional Background: Career history, education, professional philosophy
...
-- District Connections: Relationships to other districts, references, warm introductions
INSERT INTO extract_rules (name, summary, quotes, action_items, is_active)
VALUES (
...
-- Competitor Mentions: Other tools, vendors, competitors discussed
INSERT INTO extract_rules (name, summary, quotes, action_items, is_active)
VALUES (
    'Competitor Mentions',
...
-- Contract Approval Process: How contracts get approved, thresholds, key approvers
INSERT INTO extract_rules (name, summary, quotes, action_items, is_active)
VALUES (
...
-- Create tags for new rules if they don't exist
